...
import type { FilterDefinition, FilterMetadata, ImageData2D } from './filterTypes';
import { findClosestLegoColor, LEGO_COLORS, type LegoColor } from './legoColors';
import {
  rgbToLab,
  labToRgb,
  rgbToHsl,
...
export const isometricShadeFilter: FilterDefinition = {
  ...
  process: (imageData, params) => {
    ...
    const { magnitude, direction } = sobelEdgeDetection(imageData.data, imageData.width, imageData.height);
